...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(isset($FILES['imagem']) && $_FILES['imagem']['error'] === UPLOAD_ERR_OK){
        $imagem_temp =$FILES['imagem']['tmp_name'];
        $imagem = file_get_contents($imagem_temp);
        $imagem_base64 = base64_encode($image);
    }
    ...
    //SE A IMAGEM COLOCADA FOR DIFERENTE
    else{
        $sql = "UPDATE produtos SET pro_nome = '$nome', pro_descricao = '$descricao', pro_quantidade = $quantidade,
...
<div>
    ...
    <div class = "formulario">
        <form class="visualizaproduto" action="alteraproduto.php" method="post" enctype="multipart/form-data">
            ...
            <label>NOME</label>
            <input type="text" name="nome" value="<?= $descricao?>">
